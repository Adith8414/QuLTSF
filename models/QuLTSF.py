...
class Model(nn.Module):
    """
    Hybrid Quantum-Classical Time Series Forecasting Model (QuLTSF)
    """
    def __init__(self, configs):
        ...
        # ---------------- GPU QUANTUM BACKEND ----------------
        # Force GPU quantum simulator for Kaggle
        self.QML_device = 'lightning.gpu'
        # -----------------------------------------------------
...
class Hybrid_QML_Model(nn.Module):
    def __init__(self, lookback_window_size, forecast_window_size, num_qubits, QML_device, num_layers):
        ...
        # Move classical layers to GPU
        self.input_classical_layer = self.input_classical_layer.to(self.device)
        self.output_classical_layer = self.output_classical_layer.to(self.device)
    ...
    def forward(self, batch_input):
        ...
        return batch_output   # [Batch, Channel, Output length]
